...
class RegardClassifier(evaluate.Measurement):
    def __init__(self, device = 'cpu'):

        regard_tokenizer = AutoTokenizer.from_pretrained("/home/gridsan/rlohanimit/fair-nlg/bold/regardv3")
        regard_model = AutoModelForSequenceClassification.from_pretrained("/home/gridsan/rlohanimit/fair-nlg/bold/regardv3")
        self.regard_classifier = pipeline(
            "text-classification", model=regard_model, top_k=4, tokenizer=regard_tokenizer, truncation=True, device = device 
        )
